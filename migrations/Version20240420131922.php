 ...
 */
final class Version20240420131922 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `user` ADD CONSTRAINT FK_8D93D6491710BDEB FOREIGN KEY (employe_of_id) REFERENCES shop (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
